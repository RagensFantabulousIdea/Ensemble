...
15.times do
  ...
  3.times do
    ...
    5.times do
      ...
      landscape: Faker::Boolean.(0.5),
      portrait: Faker::Boolean.(0.5),
      demonstrative: Faker::Boolean.(0.5),
      ...
      3.times do
        asset.photos.create!(
          ...
          frame_num: "DSC#{rand(99999)}",
          liked: Faker::Boolean(0.5),
          disliked: Faker::Boolean(0.5),
          selected: Faker::Boolean(0.1),
