                    ...
                    <div className="row">
                        <div className="col-sm-8 col-sm-offset-2">
                            <div className="panel">
                                ...
                                <div className="panel-footer projectCardNavButtons text-center">
                                    <button type="button" className="btn projectButton" onClick={this.editsignup}>Click here to update your profile</button>
                                </div>
                            </div>
                        </div>
                    </div>
